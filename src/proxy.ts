...
// El matcher excluye assets, api y admin: redirigir un .png a /es/... lo rompe, y el panel no es contenido localizado — sin esta exclusión /admin se redirige a /es/admin, que no existe.
export const config = {
  matcher: [
