...
export const CALL_CENTER = SERVICES.find((service) => service.id === "call-center")!;

export const CAPABILITY_META: Record<string, { icon: ServiceIconName; channels: readonly string[] }> = {
...
export const CLIENT_LOGOS = [
  {
    name: "Altice",
    src: "/brands/altice.jpg",
    about: "Company profile pending — replace with an approved description of Altice's business and industry.",
    provides: "Service scope pending confirmation with the account team — replace with the capabilities Center Quest delivers for Altice.",
  },
  {
    name: "Paso Rápido",
    src: "/brands/pasoRapido.png",
    size: "large",
    about: "Company profile pending — replace with an approved description of Paso Rápido's business and industry.",
    provides: "Service scope pending confirmation with the account team — replace with the capabilities Center Quest delivers for Paso Rápido.",
  },
  {
    name: "Rig Hut",
    src: "/brands/righut.jpg",
    about: "Company profile pending — replace with an approved description of Rig Hut's business and industry.",
    provides: "Service scope pending confirmation with the account team — replace with the capabilities Center Quest delivers for Rig Hut.",
  },
  {
    name: "Cell Phone",
    src: "/brands/cellphone.jpg",
    about: "Company profile pending — replace with an approved description of Cell Phone's business and industry.",
    provides: "Service scope pending confirmation with the account team — replace with the capabilities Center Quest delivers for Cell Phone.",
  },
  {
    name: "Plastifar",
    src: "/brands/plastifar.png",
    size: "compact",
    about: "Company profile pending — replace with an approved description of Plastifar's business and industry.",
    provides: "Service scope pending confirmation with the account team — replace with the capabilities Center Quest delivers for Plastifar.",
  },
  {
    name: "Fiduciaria Reservas",
    src: "/brands/fiduciariaReservas.jpg",
    about: "Company profile pending — replace with an approved description of Fiduciaria Reservas's business and industry.",
    provides: "Service scope pending confirmation with the account team — replace with the capabilities Center Quest delivers for Fiduciaria Reservas.",
  },
] as const;
