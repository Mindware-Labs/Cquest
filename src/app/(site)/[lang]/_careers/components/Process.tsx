...
const STEPS = {
  ...
  es: [
    { title: "Te postulas", body: "Una pantalla, nueve campos y tu CV. Sin crear cuenta.", meta: "2 minutos" },
    { title: "Revisamos", body: "Recursos Humanos lee cada postulación y la compara con las vacantes que tenemos abiertas.", meta: "3–5 días hábiles" },
    { title: "Entrevista y evaluación", body: "Una conversación más una evaluación corta de idioma y digitación para los roles de piso.", meta: "1 semana" },
    { title: "Oferta e ingreso", body: "Contrato formal, capacitación pagada y tu primer grupo con la operación.", meta: "2 semanas" },
  ],
};
...
const COPY = {
  ...
  es: {
    ...
    title: ["Cuatro pasos.", "Sin caja negra."],
    lead: "Siempre sabes en qué punto está tu postulación y qué viene después.",
  },
};
