...
> = {
  crms: {
    ...
    benefit:
      "One system of record your team actually wants to use, because it works the way they do.",
  },
  dashboards: {
    includes: [
  ...
  "ai-implementation": {
    ...
    benefit:
      "AI that empowers your team and delights your customers — deployed responsibly.",
  },
};
...
export const PROCESS: ReadonlyArray<{ title: string; description: string }> = [
  {
    title: "Discovery",
    description:
      "We sit with the people who do the work and map how the operation actually runs — not how the org chart says it does.",
  },
  {
    title: "Blueprint",
    description:
      "Screens, data model and integrations are designed and validated with your team before a single line of code is written.",
  },
  {
    title: "Build",
    description:
      "Short cycles with working software at every step, so you see progress instead of waiting for a big reveal.",
  },
  {
    title: "Launch",
    description:
      "Deployment, data migration and training handled with the operation running — the business never stops.",
  },
  {
    title: "Iterate",
    description:
      "The system keeps evolving with your operation: new modules, refinements and support after go-live.",
  },
];

export const COMMITMENTS: ReadonlyArray<{ title: string; description: string }> = [
  {
    title: "Working software every cycle",
    description:
      "Progress you can click, in weekly builds — not a final reveal months later.",
  },
  {
    title: "The license is yours to keep",
    description:
      "We sell you the full license to the code we build — nothing retained on our end, nothing to license back later.",
  },
  {
    title: "Support after go-live",
    description:
      "Launch is the midpoint, not the end — the system keeps evolving with the operation it serves.",
  },
];
...
export const WORKS: readonly Work[] = [
  {
    ...
    outcome: {
      value: "Real-time",
      label: "call-to-report visibility",
    },
