  ...
  return (
    <article className={styles.page}>
      <div className={styles.shell}>
        <TransitionLink href="/services/systems#work" className={styles.back}>
        ...
        >
          ...
          <motion.div className={styles.actions} variants={focusRiseVariants}>
            <TransitionLink href="/quote?servicio=systems" className={styles.primary}>
              {dict.hero.primaryCta} <Arrow />
            </TransitionLink>
            <TransitionLink href="/services/systems#work" className={styles.secondary}>
              {t.back}
            </TransitionLink>
          </motion.div>
        </motion.section>
