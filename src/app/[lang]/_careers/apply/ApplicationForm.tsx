...
const COPY = {
  ...
  es: {
    ...
    lead: "Nueve campos, unos dos minutos. Recursos Humanos revisa cada postulación que entra.",
    fullName: "Nombre completo",
    email: "Correo",
    phone: "Teléfono / WhatsApp",
    city: "Ciudad",
    experience: "Experiencia en call center",
    english: "Nivel de inglés",
    availability: "Disponibilidad para iniciar",
    cv: "Tu CV (PDF, DOC o DOCX — máx. 5 MB)",
    cvButton: "Elegir archivo",
    cvEmpty: "Ningún archivo seleccionado",
    message: "Algo que quieras que sepamos (opcional)",
    messagePlaceholder: "Cuéntanos brevemente por qué te postulas.",
    choose: "Selecciona una opción",
    consent: "Acepto que Center Quest guarde y procese mis datos con fines de reclutamiento.",
    privacy: "Política de privacidad",
    submit: "Enviar postulación",
    sending: "Enviando…",
    fixFields: "Revisa los campos marcados.",
    successTitle: "Postulación recibida",
    successBody:
      "Recursos Humanos revisa cada CV. Si tu perfil calza con una vacante, te contactamos por teléfono o WhatsApp.",
    another: "Enviar otra postulación",
    backToOpenings: "Volver a las vacantes",
    applyingFor: "Te postulas a",
...
export default function ApplicationForm({
  ...
  const { lang } = useI18n();
  const t = COPY[lang];
  const messages = applicationMessages(lang);
  ...
  async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const cvCheck = checkCvFile(cvValue instanceof File ? cvValue : null, lang);
      ...
      <section id={id} className={styles.panel}>
        <div className={styles.done} role="status">
          ...
          <div className={styles.doneActions}>
            ...
            <LocalizedLink href="/careers#openings" className={styles.ghostCta}>
    ...
    <section id={id} className={styles.panel}>
      ...
      <form className={styles.form} onSubmit={onSubmit} noValidate>
        ...
        <div className={styles.grid}>
          ...
          <Select id={`${id}-experience`} name="experience" label={t.experience} placeholder={t.choose} options={EXPERIENCE_OPTIONS} lang={lang} error={errors.experience} />
          <Select id={`${id}-english`} name="english" label={t.english} placeholder={t.choose} options={ENGLISH_OPTIONS} lang={lang} error={errors.english} />
          <Select id={`${id}-availability`} name="availability" label={t.availability} placeholder={t.choose} options={AVAILABILITY_OPTIONS} lang={lang} error={errors.availability} />
        ...
        <div className={styles.consentRow}>
          <label className={styles.consent} htmlFor={`${id}-consent`}>
            ...
            <span>
              {t.consent}{" "}
              <LocalizedLink href="/legal/privacy" className={styles.privacyLink}>
                {t.privacy}
              </LocalizedLink>
            </span>
          </label>
