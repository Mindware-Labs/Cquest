...
export default function ServiceIcon({ name }: { name: ServiceIconName }) {
  const paths = {
    ...
    "flag-mountain": <><path d="M3 20 9.5 8l3.2 5.5L15.5 9 21 20Z" /><path d="M9.5 8 12 4l1.3 2.3" /></>,
    eye: <><path d="M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12Z" /><circle cx="12" cy="12" r="3" /></>,
    diamond: <><path d="M4.5 9 8 4h8l3.5 5-7.5 11Z" /><path d="M4.5 9h15M8 4l1.5 5L12 20l2.5-11L16 4M8 4l-3.5 5M16 4l3.5 5" /></>,
  };
