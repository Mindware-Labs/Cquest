...
// El primario usa verde-oscuro y no el verde de marca: bg-verde text-white daba 2.85:1, por debajo del 4.5:1 de WCAG 1.4.3; oscurecer el fondo (no la tinta) sube a 5.28:1 sin romper el par de color del CTA.
const BUTTON = {
...
export default function CtaBlock({ block }: { block: BlockOf<"cta"> }) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-6">
        {/* Un destino interno pasa por LocalizedLink para llevar el prefijo de idioma; uno externo es un <a> normal, con rel de seguridad. */}
